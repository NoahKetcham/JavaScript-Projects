...
function placeXOrO(squareNumber) {
    ...
    //to see if it coantains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/alphabet.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer isequal 'O', the 0.png is placed in html
            select.style.backgroundImage = 'url("images/ONew.png")';
        }
        ...
        //This fynction plays placement sound.
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //if the 3 variuables we pass are all included in our array then
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary yaxis data we update in our animation loop.
        y = y1;
        //this function interacts with the canvas.
    function animateLineDrawing() {
        //This variable interacts with the canvas.
        const animationLoop = requestAnimationFrame(animateLineDrawing);
        //This method clears content from the loop iteration.
        c.clearRect(0, 0, 608, 608);
        //This method starts a new path.
        c.beginPath();
        //This method moves us to a atarting point in our line.
        c.moveTo(x1, y1);
        ...
        c.stroke();
        //This condition checks if we've reached our endpoints.
        if (x1 <= x2 && y1 <= y2) {
...
function resetGame() {
    ...
    //This resets our array so it is empty and we can starert over.
    selectedSquares = [];
}