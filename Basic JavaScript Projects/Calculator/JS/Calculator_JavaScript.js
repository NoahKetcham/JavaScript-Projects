...
const Calculator = {
    ...
    Display_Value: '0',
    //This will howld the first operand for any ex[ressions, we set it to null for now.
    First_Operand: null,
    //This checks wether or not the second operand has been inputtedby the user.
...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        //this overwrites Display_Valueif the current value is 0
...
function Handle_Operator(Next_Operator) {
    ...
    //Checks if an operator already exists and if waitSO is true,
