...
//This function adds the inputed task to the get_tools function array.
function add() {
...
function show() {
    ...
    var html = '<ul>';
    //This displays a task t the list in the order that it is inputed.
    for (var i = 0; i < todos.length; i++) {
        //This also displays the task as a lsit and creates the button with the "x".
    ...
    //array after an item has beem removed.
